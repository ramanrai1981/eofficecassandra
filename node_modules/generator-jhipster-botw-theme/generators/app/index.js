...
const jhipsterVar = { moduleName: 'botw-theme' };
...
module.exports = generator.extend({
    ...
    initializing: {
        ...
        displayLogo() {
            ...
            this.log(`Welcome to the ${chalk.bold.yellow('JHipster botw-theme')} generator! ${chalk.yellow(`v${packagejs.version}\n`)}`);
        }
    },
    ...
    install() {
        ...
        this.log('End of botw-theme generator');
    }
});
