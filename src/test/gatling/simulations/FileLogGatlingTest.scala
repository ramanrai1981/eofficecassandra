...
/**
 * Performance test for the FileLog entity.
 */
class FileLogGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the FileLog entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created fileLog")
                .get("${new_fileLog_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created fileLog")
            .delete("${new_fileLog_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
